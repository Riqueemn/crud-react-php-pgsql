...
export default class Editar extends Component{
    ...
    getId(){
        fetch('http://localhost/projetos/crud/react-php-postgre-2/src/api/getId.php?id=' + this.props.match.params.id)
    ...
    onSubmit(e){
        ...
        fetch('http://localhost/projetos/crud/react-php-postgre-2/src/api/editar.php?id=' + this.props.match.params.id, {
            method: 'POST',
            headers: {
